...
parser.add_argument('--mode', choices=['normal'], type=str, default='normal')# select the minimal value for avoiding zero-division
...
if __name__=='__main__':
    ...
    elif args.method == 'FedWMSAM':
        server_func = FedWMSAM
    else:
